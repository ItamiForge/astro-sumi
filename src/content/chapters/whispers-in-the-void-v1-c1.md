...
wordCount: 2400
pageCount: 6
summary: "Dr. Elena Vasquez's routine shift takes an extraordinary turn when humanity receives its first alien transmission—a signal that defies all known communication models."
draft: false
order: 1
pageBreaks: [
  { title: "Night Shift", anchor: "page-1" },
  { title: "The Signal", anchor: "page-3" },
  { title: "Impossible Patterns", anchor: "page-5" }
]
---
