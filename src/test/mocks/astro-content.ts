...
export async function render(_entry: any) {
  return {
    ...
    headings: [
      {
        slug: 'chapter-1-the-fractured-crystal',
        text: 'Chapter 1: The Fractured Crystal',
        depth: 1,
      },
      { slug: 'academy-arrival', text: 'Academy Arrival', depth: 2 },
      {
        slug: 'the-crystal-laboratory',
        text: 'The Crystal Laboratory',
        depth: 2,
      },
      { slug: 'resonance-gone-wrong', text: 'Resonance Gone Wrong', depth: 2 },
      {
        slug: 'aftermath-and-questions',
        text: 'Aftermath and Questions',
        depth: 2,
      },
    ],
