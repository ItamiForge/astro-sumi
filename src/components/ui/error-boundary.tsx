...
/**
 * Error Boundary specifically for external services (like Giscus)
 */
export class ExternalServiceErrorBoundary extends Component<
  {
    children: ReactNode
    serviceName: string
    fallback?: ReactNode
...
> {
  ...
  componentDidCatch(error: Error, errorInfo: React.ErrorInfo) {
    Logger.error(`External service error in ${this.props.serviceName}`, error, {
      componentStack: errorInfo.componentStack,
      ...
      return (
        <div className="rounded-lg border border-gray-200 p-4 text-center dark:border-gray-700">
          ...
          <p className="mb-3 text-sm text-gray-600 dark:text-gray-400">
            {this.props.serviceName} is temporarily unavailable
          </p>
